...
function plot_spectrogram(signal, Fs, window_sec, overlap)
    ...
    Ps = 10*log10(P + 0.00000000001); % Can't take log of 0

    figure;
    imagesc(F, seconds, Ps);
    colorbar;
    xlim([0, 5]);
